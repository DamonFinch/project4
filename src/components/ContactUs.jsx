const ContactUs = ({ }) => {
  ...
  return (
    <div id="contactus" className="bg-[#131835] py-10">
      <div className="w-4/5 mx-auto">
        <h4 className="text-gradient uppercase text-3xl">Contact Us</h4>
            ...
            <div class="grow-0 shrink-0 basis-auto mb-12 lg:mb-0 w-full lg:w-5/12 px-3 lg:px-6">
              <form>
                <div class="form-group mb-6">
                  ...
                  font-normal
                  text-white
                  bg-[#131835] bg-clip-padding
                  border border-solid border-gray-300
                  rounded
                  transition
                  ease-in-out
                  m-0
                  focus:text-white focus:bg-[#131835] focus:border-blue-600 focus:outline-none" id="exampleInput7"
                    placeholder="Name"/>
                </div>
                <div class="form-group mb-6">
                  ...
                  ease-in-out
                  m-0
                  focus:text-white focus:bg-[#131835] focus:border-blue-600 focus:outline-none" id="exampleInput8"
                ...
                <div class="form-group mb-6">
                  ...
                  ease-in-out
                  m-0
                  focus:text-white focus:bg-[#131835] focus:border-blue-600 focus:outline-none
                " id="exampleFormControlTextarea13" rows="3" placeholder="Message"></textarea>
                </div>
                <button type="submit" class="shadow-xl shadow-black text-white w-full
                  bg-[#e32970] hover:bg-[#bd255f] p-2 pl-4 pr-4
                  rounded-full cursor-pointer my-4">Send</button>
              </form>
            </div>
            <div class="grow-0 shrink-0 basis-auto w-full lg:w-7/12 text-white">
              <div class="flex flex-wrap">
                ...
                <div class="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
                  <div class="flex items-start">
                    ...
                    <div class="grow ml-6">
                      ...
                      <p class="text-gray-300">sales@example.com</p>
                      <p class="text-gray-300">+1 234-567-89</p>
                    </div>
                  </div>
                </div>
                <div class="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
                  <div class="flex align-start">
                    ...
                    <div class="grow ml-6">
                      ...
                      <p class="text-gray-300">press@example.com</p>
                      <p class="text-gray-300">+1 234-567-89</p>
                    </div>
                  </div>
                </div>
                <div class="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
                  <div class="flex align-start">
                    ...
                    <div class="grow ml-6">
                      ...
                      <p class="text-gray-300">bugs@example.com</p>
                      <p class="text-gray-300">+1 234-567-89</p>
                    </div>
                  </div>
                </div>
